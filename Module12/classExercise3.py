...
class MyGUI:
    ...
    def __init__(self):
        ...
        self.label3 = tkinter.Label(self.main_window, text='For small creatures such as we the vastness is bearable only through love.', borderwidth=1, relief='solid')
        self.label4 = tkinter.Label(self.main_window, text='Singing is like a celebration of oxygen.', borderwidth=1, relief='solid')
